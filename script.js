...
// Player data is already provided in the file
...
function populateTeamFilter() {
    ...
    const teams = [...new Set(playerData.map(player => player.team))];
    teams.forEach(team => {
...
function initializeDashboard() {
    populateTable(playerData); // Populate table initially
    populateTeamFilter(); // Populate team filter dropdown

    // Add event listeners
    document.getElementById("search").addEventListener("input", filterAndSearch);
    document.getElementById("team-filter").addEventListener("change", filterAndSearch);
    document.getElementById("dark-mode-toggle").addEventListener("click", toggleDarkMode);
}

// Run the dashboard setup when the DOM is loaded
